...
export function LandingScreen({ token, share, streakCount, rewardCoins, category, type, tips, caseId, body, media, post }: LandingScreenProps) {
  ...
  }, [trigger, router, mutateAccount, share, tips, caseId, body, media, post]);
